...
int main (int argc, char *argv[])
{
  ...
  enbpositionAlloc->Add(Vector(100+distance,100,0));
  enbpositionAlloc->Add(Vector(100,100+distance,0));
  enbpositionAlloc->Add(Vector(100+distance,100+distance,0));

  
  //Placing UEs
  Ptr<ListPositionAllocator> uepositionAlloc = CreateObject<ListPositionAllocator> ();
  uepositionAlloc->Add (Vector(150, 150, 0));
  uepositionAlloc->Add (Vector(550, 150, 0));
  uepositionAlloc->Add (Vector(150, 550, 0));
  uepositionAlloc->Add (Vector(550, 550, 0));
